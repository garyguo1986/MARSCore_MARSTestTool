codeunit 1059706 "MARS Test Runner - Mgt"
{
    ...
    procedure RunTests(var NewTestMethodLine: Record "MARS Test Method Line")
    var
    ...
    begin
        exit(CODEUNIT::"MARS Test Runner Isol. Disable");
    end;

    procedure GetCodeIsolationTestRunner(): Integer
    begin
        exit(CODEUNIT::"MARS Test Runner Isol. CU");
    end;
    ...
    var
        TestMethodLineFunction: Record "MARS Test Method Line";
    ...
    local procedure UpdateCodeunitLine(var CodeunitTestMethodLine: Record "MARS Test Method Line"; TestMethodLine: Record "MARS Test Method Line"; IsSuccess: Boolean)
    var
    ...
    local procedure SetStartTimeOnTestLine(var TestMethodLine: Record "MARS Test Method Line")
    begin
    ...
    local procedure UpdateTestFunctionLine(var TestMethodLineFunction: Record "MARS Test Method Line"; IsSuccess: Boolean)
    var
        TestSuiteMgt: Codeunit "MARS Test Suite Mgt.";
    begin
    ...
    local procedure GetTestFunction(var TestMethodLineFunction: Record "MARS Test Method Line"; FunctionName: Text[128]; TestSuite: Code[10]; TestCodeunit: Integer; LineNoTestFilter: Text): Boolean
    begin
    ...
    local procedure GetTestCodeunit(var CodeunitTestMethodLineFunction: Record "MARS Test Method Line"; TestSuite: Code[10]; TestCodeunit: Integer): Boolean
    begin
    ...
    local procedure OnRunTestSuite(var TestMethodLine: Record "MARS Test Method Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterRunTestSuite(var TestMethodLine: Record "MARS Test Method Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCodeunitRun(var TestMethodLine: Record "MARS Test Method Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCodeunitRun(var TestMethodLine: Record "MARS Test Method Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeTestMethodRun(var CurrentTestMethodLine: Record "MARS Test Method Line"; CodeunitID: Integer; CodeunitName: Text[30]; FunctionName: Text[128]; FunctionTestPermissions: TestPermissions)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterTestMethodRun(var CurrentTestMethodLine: Record "MARS Test Method Line"; CodeunitID: Integer; CodeunitName: Text[30]; FunctionName: Text[128]; FunctionTestPermissions: TestPermissions; IsSuccess: Boolean)
    begin
    end;
}
